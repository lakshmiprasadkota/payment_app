...
import 'package:payment_app/screens/details.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title:     Text("Add Transaction",style: TextStyle( color: Color(0xff2c2c2c),fontWeight: FontWeight.w600,fontSize: 18),),
      ),
            ...
            children: [
              ...
              InkWell(
                onTap: (){
                  ...
                  context,
                  MaterialPageRoute(
                  builder: (context) => Details(title: title,
                    transaction: transactionDropox,
                   tag: tagsDropbox,
                   when: _formattedate,
                   amout: amount,note: note,
                  ),
                  ),
                  );
                },
